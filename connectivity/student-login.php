...
<body class="min-h-screen flex items-center justify-center">
    <div class="login-card w-full max-w-md p-8 space-y-6 bg-white rounded-xl">
        ...
        <form class="space-y-4" action="php/php/student_login.php" method="POST" >
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="student-id" name="student_id" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500" placeholder="Enter your student ID" required>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" id="password" name="password" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500" placeholder="Enter your password" required>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="./student_forgotpassword.php"  class="font-medium text-green-600 hover:text-green-500">Forgot password?</a>
                </div>
            </div>
