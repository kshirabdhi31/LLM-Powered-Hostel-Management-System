...
$query = "SELECT * FROM notices ORDER BY start_date DESC";
...
<head>
    ...
    <style>
        body {
            ...
            background-color:rgb(240, 250, 221);
        }
        .sidebar {
            transition: all 0.3s;
            width: 300px;
...
<div class="sidebar text-white p-6 flex-shrink-0 hidden md:block">
        ...
        <li>
                ...
                <li>
                    <a href="student-notices.php" class="flex items-center space-x-3 p-3 bg-teal-900">
        ...
        <div class="p-6">            
            ...
            <?php if($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <div class="notice-card rounded-lg shadow p-6 bg-white">
                                ...
                                <div>
                                    ...
                                    <div class="mt-3 flex gap-4 text-xs">
                                        <span class="text-blue-600">
                                            Start: <?php echo date('d M Y', strtotime($row['start_date'])); ?>
                                        </span>
                                        <span class="text-pink-600">
                                            End: <?php echo date('d M Y', strtotime($row['end_date'])); ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
